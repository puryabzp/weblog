...
# from django.contrib.auth.models import AbstractUser  #==> with abstract user
...
#     profile_name = models.CharField(_('profile_name'), max_length=150, null=True, blank=True)
#     email = models.EmailField(_('email_address'), unique=True, db_index=True)
#     avatar = models.ImageField(_('image_field'), upload_to='user/avatars', blank=True)
